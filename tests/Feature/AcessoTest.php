...
class AcessoTest extends TestCase
{
    ...
    {
        $club = Club::create(['nome' => 'Clube Acesso', 'cidade' => 'SP']);
        $tesoureiro = User::factory()->create(['role' => 'tesoureiro', 'club_id' => $club->id]);
        $unidade = \App\Models\Unidade::factory()->create(['club_id' => $club->id]);
        $desbravador = Desbravador::factory()->create(['unidade_id' => $unidade->id]);
        $evento = Evento::factory()->create(['club_id' => $club->id]);
    ...
    {
        $club = Club::create(['nome' => 'Clube Acesso', 'cidade' => 'SP']);
        $secretario = User::factory()->create(['role' => 'secretario', 'club_id' => $club->id]);
        $patrimonio = Patrimonio::factory()->create(['club_id' => $club->id]);
