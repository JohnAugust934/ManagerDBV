        ...
        <div class="max-w-4xl mx-auto">
            <div class="ui-card overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-900/40">
                    <h3 class="ui-title text-lg">Dados do Bem</h3>
                    <p class="ui-subtitle mt-1">Preencha as informações para adicionar um novo item ao inventário do clube.</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('patrimonio.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="item" name="item" type="text" class="mt-1 block w-full"
                                :value="old('item')" placeholder="Ex: Barraca Iglu 4 Pessoas, Caixa de Som" required autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="quantidade" name="quantidade" type="number" min="1" step="1"
                                    class="mt-1 block w-full" :value="old('quantidade', 1)" required />
                            ...
                            <div>
                                ...
                                <select id="estado_conservacao" name="estado_conservacao" class="ui-input mt-1" required>
                                    ...
                                    @foreach (['Novo', 'Otimo', 'Bom', 'Regular', 'Ruim', 'Pessimo', 'Inservivel'] as $estado)
                                        <option value="{{ $estado }}" {{ old('estado_conservacao') == $estado? 'selected' : '' }}>
                                            {{ $estado }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="valor_estimado" name="valor_estimado" type="number" step="0.01" min="0"
                                    class="mt-1 block w-full" :value="old('valor_estimado')" placeholder="0.00" />
                            ...
                            <div>
                                ...
                                <x-text-input id="data_aquisicao" name="data_aquisicao" type="date" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-text-input id="local_armazenamento" name="local_armazenamento" type="text" class="mt-1 block w-full"
                                :value="old('local_armazenamento')" placeholder="Ex: Armario A, Sala da Diretoria" />
                        ...
                        <div>
                            ...
                            <textarea id="observacoes" name="observacoes" rows="3" class="ui-input mt-1 resize-none"
                                placeholder="Descreva detalhes, numero de serie, cor ou avarias.">{{ old('observacoes') }}</textarea>
                        ...
                        <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 pt-5 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <button type="submit" class="ui-btn-primary w-full sm:w-auto">Salvar Item</button>
                        </div>
                    </form>
                </div>
            </div>
