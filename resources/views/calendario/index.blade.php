<x-app-layout>
    ...
    <div class="ui-page space-y-6 max-w-5xl mx-auto">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <h2 class="text-base sm:text-xl font-black text-slate-800 dark:text-white text-center capitalize">
        ...
        <div class="ui-card p-4 overflow-hidden">
            <div class="grid grid-cols-7 mb-2">
                @foreach (['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'] as $diaSemana)
                    <div class="text-center text-[11px] font-black text-slate-400 uppercase tracking-widest py-2">{{ $diaSemana }}</div>
                @endforeach
            </div>
