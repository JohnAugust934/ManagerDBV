...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-gray-100 dark:border-slate-700"
