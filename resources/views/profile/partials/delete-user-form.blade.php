<section class="space-y-6" x-data="{ confirmingUserDeletion: false }">
    ...
    <div x-show="confirmingUserDeletion" x-cloak class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div x-show="confirmingUserDeletion" 
             ...
             class="fixed inset-0 bg-gray-900/75 dark:bg-black/80 backdrop-blur-sm transition-opacity"></div>
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto w-full">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div x-show="confirmingUserDeletion" @click.away="confirmingUserDeletion = false" @keydown.escape.window="confirmingUserDeletion = false"
                     ...
                     class="relative transform overflow-hidden rounded-3xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <form method="post" action="{{ route('profile.destroy') }}" class="p-8">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-12 h-12 rounded-2xl bg-red-100 dark:bg-red-500/20 text-red-500 dark:text-red-400 flex items-center justify-center shrink-0">
                                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/></svg>
                            </div>
