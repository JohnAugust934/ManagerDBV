<x-guest-layout>
    <div class="mb-6 text-center sm:text-left">
        <h2 class="text-2xl sm:text-3xl font-black text-white tracking-tight mb-1.5 drop-shadow-md">Finalizar Cadastro</h2>
        <p class="text-slate-300 text-sm font-medium">
            Você foi convidado para o cargo:
            <span class="font-black uppercase tracking-wide text-[#FCD116]">{{ $invitation->role }}</span>
        </p>
    </div>

    <form method="POST" action="{{ route('register.store_invite') }}" class="space-y-4">
        @csrf
        ...
        {{-- Senha --}}
        <div>
            <label for="password" class="block text-xs font-bold text-slate-300 uppercase tracking-widest mb-2 ml-1">Defina sua Senha</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        ...
        {{-- Confirmar Senha --}}
        <div>
            <label for="password_confirmation" class="block text-xs font-bold text-slate-300 uppercase tracking-widest mb-2 ml-1">Confirme a Senha</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
