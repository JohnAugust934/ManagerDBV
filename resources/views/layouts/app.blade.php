...
<body
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 md:pl-0 transition-all duration-300">
            ...
            <header
                class="flex items-center justify-between h-16 px-4 sm:px-6 bg-white dark:bg-dbv-dark-surface border-b border-gray-200 dark:border-slate-700 shadow-sm z-30 sticky top-0 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <h1
                        class="text-lg sm:text-xl font-extrabold text-dbv-blue dark:text-gray-100 truncate tracking-tight">
            ...
            <main
                class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50/50 dark:bg-dbv-dark-bg p-4 sm:p-6 lg:p-8 transition-colors scroll-smooth">

                @if (session('success'))
                    <div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 5000)"
                        class="mb-6 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 flex items-start justify-between shadow-sm">
                        <div class="flex items-center">
                        ...
                        <button @click="show = false"
                            class="text-green-500 hover:text-green-700 dark:hover:text-green-200 transition p-1">&times;</button>
                    </div>
                @endif

                @if (session('error'))
                    <div x-data="{ show: true }" x-show="show" x-transition
                        class="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 flex items-start justify-between shadow-sm">
                        <div class="flex items-center">
                        ...
                        <button @click="show = false"
                            class="text-red-500 hover:text-red-700 dark:hover:text-red-200 transition p-1">&times;</button>
                    </div>
                @endif
