<x-app-layout>
    <div class="ui-page min-h-full">
        <div class="max-w-4xl mx-auto">
            ...
            <x-page-title title="Novo Evento" :back="route('eventos.index')" />

            <div
                class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 overflow-hidden">

                {{-- Cabeçalho do Card --}}
                <div class="bg-slate-50 dark:bg-slate-700/50 px-6 py-4 border-b border-slate-100 dark:border-slate-700">
