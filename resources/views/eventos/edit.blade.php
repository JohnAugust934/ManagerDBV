    ...
    <div class="ui-page min-h-full">
        <div class="max-w-4xl mx-auto">
            ...
            <div
                ...
                <div
                    class="bg-slate-50 dark:bg-slate-700/50 px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
                    <h3 class="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                        Dados do Evento
                    </h3>
                    <span class="text-xs text-slate-400">ID: {{ $evento->id }}</span>
                </div>
                    ...
                    <form action="{{ route('eventos.update', $evento->id) }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="data_inicio"
                                        class="block mt-1 w-full border-blue-200 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <p class="text-xs text-slate-500 mt-1">Digite 0,00 se for gratuito.</p>
                        ...
                        {{-- BOTÕES DE AÇÃO --}}
                        <div
                            class="pt-6 border-t border-slate-100 dark:border-slate-700 flex items-center justify-end gap-4">
