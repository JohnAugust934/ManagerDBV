    ...
    <div class="ui-page" x-data="{
        ...
        <div x-show="showModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto"
            ...
            <div x-show="showModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                ...
                class="fixed inset-0 bg-slate-500 bg-opacity-75 transition-opacity backdrop-blur-sm"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div x-show="showModal" x-transition:enter="ease-out duration-300"
                    ...
                    class="relative transform overflow-hidden rounded-2xl bg-white dark:bg-slate-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md border border-slate-100 dark:border-slate-700">
                    ...
                    {{-- Botões do Modal --}}
                    <div class="bg-slate-50 dark:bg-slate-700/30 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-2">
                        ...
                        <button type="button" x-on:click="showModal = false"
                            class="mt-3 inline-flex w-full justify-center rounded-lg bg-white dark:bg-slate-800 px-3 py-2 text-sm font-semibold text-slate-900 dark:text-slate-300 shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 sm:mt-0 sm:w-auto">
                            Corrigir
                        </button>
                    </div>
                </div>
